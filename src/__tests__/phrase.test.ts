import { MockPhrase } from '../MockPhrase';
...
describe('Phrase tests', () => {
   ...
   it('should intersect phrases', () => {
      ...
      let phrase: Phrase = new Phrase(str1);
      let words: string[] = phrase.intersection(str2);

      expect(words).toEqual(expected)
   });

   it('should mock intersection method', () => {

      let expected: string[] = ["data", "the", "to", "way"]
      let phrase: Phrase = new MockPhrase("allo mon coco");
      let words: string[] = phrase.intersection("bonjour");
   ...
   it('should mock intersection method', () => {
      ...
      let phrase: Phrase = new MockPhrase("allo mon coco");
     let phrase2:Phrase = phrase.duplicate();
